class Education::Management::ProjectsController <
  ...
  def create
    ...
    if @project.save
      ...
      redirect_to education_management_project_path @project
    else
      render :new
    end
  end
  ...
  def edit
    respond_to do |format|
      format.html
      format.js do
        render partial: "education/management/projects/form",
          locals: {project: @project, button_text: t(".update_project"),
          url: education_management_project_path},
          layout: false
      end
    end
  end
